...
var skyboxCubemap3 = new THREE.CubeTextureLoader()
...
// CREATIVE PORTION, ENVIRONMENT MAPPING
...
var reflectionMaterial2 = new THREE.ShaderMaterial({
	uniforms: {
...
var refractionMaterial = new THREE.ShaderMaterial({
	uniforms: {
		skybox: { type: "t", value: skyboxCubemap3 },
	},
    side: THREE.DoubleSide
})
// -------------------------------
...
var shaderFiles = [
  ...
  'glsl/reflection.vs.glsl',
  'glsl/reflection.fs.glsl',

  'glsl/reflection2.vs.glsl',
  'glsl/reflection2.fs.glsl',
...
new THREE.SourceLoader().load(shaderFiles, function(shaders) {
	...
	reflectionMaterial.vertexShader = shaders['glsl/reflection.vs.glsl']	
	reflectionMaterial.fragmentShader = shaders['glsl/reflection.fs.glsl']
	reflectionMaterial2.vertexShader = shaders['glsl/reflection2.vs.glsl']	
	reflectionMaterial2.fragmentShader = shaders['glsl/reflection2.fs.glsl']
...
loadOBJ(finalScene, 'obj/armadillo.obj', refractionMaterial, 1.0, 0, 1.0, 0, 0, 3.14, 0)
...
var reflectionSphere2 = new THREE.Mesh(mapSphere, reflectionMaterial2);
...
function updateMaterials() {
	...
	reflectionMaterial2.needsUpdate = true
